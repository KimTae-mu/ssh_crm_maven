  ...
  <script type="application/javascript">
    ...
    function checkCode() {
        ...
        if(code.trim()==""){
            ...
            var url="${pageContext.request.contextPath }/userAction_checkCode.action";
...
<BODY>
<FORM id=form1 name=form1 action="${pageContext.request.contextPath }/userAction_regist.action" onsubmit="return checkForm()" method=post>
